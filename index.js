...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN: SAMURÁI\n' //ganti nama lu! 
            + 'ORG:  🏴‍☠️⃝⃤⃢𝖘𝖆𝖒𝖚𝖗𝖆🇮🇱𝖎⃢⃝⃤✞;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=573184581139:+57 3184581139\n'  //ganti nomor lu! 
            + 'END:VCARD'
prefix = '!'
blocked = []   
limitawal = 99999
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('Escsnea es QR..','white'),color('Samuraiツ','red'),color('X','lime'),color('TQM','red'))
})
...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `*Hola* @${num.split('@')[0]}\n*Bienbenido a ${mdata.subject} Espero la pases super`
				...
				try {
					...
					teks = `Te faltaba odio\n
 @${num.split('@')[0]}\n Total no te extrañaremos`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('message-new', async (mek) => {
		...
		try {
			...
			const groupAdmins = isGroup ? getGroupAdmins(groupMembers) : ''
           	const ftoko = { key: { fromMe: false, participant: `573184581139@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./src/logobot.jpg') }, "title": `Subrek ItsAra`, "productImageCount": 9999 }, "businessOwnerJid": `573184581139@s.whatsapp.net`}}}
            ...
            //Saya Mohon Jangan hapus tqto ya teman teman 
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    wew = fs.readFileSync(`./src/logobot.jpg`)
                      zain = `
「 INFO BOT 」
◨ Yo soy: 🏴‍☠️⃝⃤⃢𝖘𝖆𝖒𝖚𝖗𝖆🇮🇱𝖎⃢⃝⃤✞
◨ Mi link: wa.me/573184581139
◨ Mi prefijo es: 「  ${prefix}  」

「 INFO USER 」
◨ Tu eres: ${pushname}
◨ Tu numero: wa.me/${sender.split("@")[0]}
...
╚╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍⊱
` 
client.sendMessage(from, wew, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "🏴‍☠️⃝⃤⃢𝖘𝖆𝖒𝖚𝖗𝖆🇮🇱𝖎⃢⃝⃤✞\n*Me La Chupas We*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('src/reply.jpg')} } }, caption: zain, pushname, prefix, getLevelingXp, getLevelingLevel, sender, role })
break
...
case 'add':
					...
					break
		case 'bot':
					client.sendMessage(from, '😉Aca estoy we dime que necesitas \n Usa !smbot para ver mis funciones 🧙‍♂️"',MessageType.text, { quoted: mek} )
					break
		case 'wa.me':
		case 'wame':
		...
		case 'clearall':
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '🧙‍♂️Y si me la Chupas🥺... '})
						fs.unlinkSync(ran)
					})
					break
            case 'stickergif':
		...
		case 'kick':
					...
					if (!isGroupAdmins) return reply(ind.admin())
					if (!isBotGroupAdmins) return reply(ind.badmin())
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Lo siento We adiós 👋!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `*╔╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍⊱
┣> *Para Fuera Por No Mostrar esas Nalgas :v*
╚╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍⊱
* 🤭 :\n`
							teks += `@_.split('@')[0]`
						}
						...
						mentions(`*╔╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍⊱
┣◹ *🧙‍♂️Para Fuera Por No Mostrar esas Nalgas🥵
╚╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍⊱
...
break
		...
		if (budy.includes(`Gracias`)) {
                  reply(`Grcias no Bebe\n Muestra Ya esas nalgas 🥵 ${pushname}`)
                  }
		if (budy.includes(`573184581139`)) {
                  reply(`Mas rato responde esta ocupado>:V`)
