...
exports.lvlon = () => {
	return`*「 ENCENDIDO 」 LEVELING*`
}

exports.lvloff = () => {
	return`*「 APAGADO 」 LEVELING*`
}
...
exports.noregis = () => {
	return`*「 REGISTRO」*\n\n*Usa${prefix} registrar nombre:edad* \n*ejemplo ${prefix}registrar smbot:18*`
}
...
exports.limitend = (pushname) => {
	return`*Maaf ${pushname} limit hari ini habis*\n*Hubungi kami* : wa.me/573184581139\n\n*Note : Kami akan berikan random dari 1-10*`
}
